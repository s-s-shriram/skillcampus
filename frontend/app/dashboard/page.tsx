  ...
  return (
    <main className="dashboard-page">
      ...
      {profile && <section className="dashboard-grid">
        ...
        <article className="dashboard-card"><span>PROGRAMMING</span><h2>Practice</h2><p>C, C++, Java, Python and SQL questions.</p><Link className="card-link" href="/programming">Start programming →</Link></article>
